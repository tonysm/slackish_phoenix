defmodule SlackishPhoenix.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: SlackishPhoenix.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SlackishPhoenixWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
